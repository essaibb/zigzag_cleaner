...
class RectangularZigzagVerticalWithPoles:
    ...
    def __init__(self):
        ...
        self.shift_distance = 0.75   # المسافة العادية
        ...
        rospy.loginfo("✅ Rectangular Vertical ZigZag STARTED (Stop at Row 8 Enabled)")
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            # ========= SHIFT =========
                ...
                # 🧠 تكبير الإزاحة عند الصفوف 5 و 6 فقط
            ...
            # ========= TURN 2 =========
                ...
                if abs(error) < 0.03:
                    ...
                    self.row_count += 1
                    rospy.loginfo(f" Row completed: {self.row_count}")

                    # 🛑 إيقاف الروبوت عند الصف الثامن
                    if self.row_count == 8:
                        rospy.loginfo("Reached Row 8 - Robot Stopped")
                        ...
                        rospy.signal_shutdown("Finished 8 rows")
                        return
